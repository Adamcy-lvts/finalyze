...
Route::prefix('admin')->middleware(['auth', 'role:super_admin|admin|support'])->group(function () {
    ...
    Route::prefix('system')->group(function () {
        ...
        Route::get('/project-categories', [AdminProjectCategoryController::class, 'index'])->name('admin.system.project-categories');
        Route::post('/project-categories', [AdminProjectCategoryController::class, 'store'])->name('admin.system.project-categories.store');
        Route::put('/project-categories/{category}', [AdminProjectCategoryController::class, 'update'])->name('admin.system.project-categories.update');
        Route::delete('/project-categories/{category}', [AdminProjectCategoryController::class, 'destroy'])->name('admin.system.project-categories.destroy');
        Route::put('/project-categories/{category}/active', [AdminProjectCategoryController::class, 'toggleActive'])->name('admin.system.project-categories.toggle-active');
        Route::get('/project-categories', [AdminProjectCategoryController::class, 'index'])->name('admin.system.project-categories');
        Route::post('/project-categories', [AdminProjectCategoryController::class, 'store'])->name('admin.system.project-categories.store');
        Route::put('/project-categories/{category}', [AdminProjectCategoryController::class, 'update'])->name('admin.system.project-categories.update');
        Route::delete('/project-categories/{category}', [AdminProjectCategoryController::class, 'destroy'])->name('admin.system.project-categories.destroy');
